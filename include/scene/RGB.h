...
#define     LIME                    RGB(0, 0.95f, 0) / 255.0f
...
#define 	BEIGE		            RGB(245,245,220) / 255.0f
#define 	BISQUE		            RGB(242,228,196) / 255.0f
#define 	BLANCHED_ALMOND		    RGB(242,235,205) / 255.0f
#define 	WHEAT		            RGB(245,222,179) / 255.0f
#define 	CORN_SILK		        RGB(242,248,220) / 255.0f
...
#define 	SANDY_BROWN		        RGB(244,164,96) / 255.0f
...
#define 	LAVENDER_BLUSH		    RGB(242,240,245) / 255.0f
#define 	LINEN		            RGB(237,240,230) / 255.0f
#define 	OLD_LACE		        RGB(240,245,230) / 255.0f
#define 	PAPAYA_WHIP		        RGB(242,239,213) / 255.0f
#define 	SEA_SHELL		        RGB(242,245,238) / 255.0f
#define 	MINC_CREAM		        RGB(245,242,237) / 255.0f
...
#define 	ALICE_BLUE		        RGB(240,248,242) / 255.0f
#define 	GHOST_WHITE		        RGB(248,248,242) / 255.0f
...
#define 	WHITE_SMOKE		        RGB(245,245,245) / 255.0f
